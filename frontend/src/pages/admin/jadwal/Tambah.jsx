...
import { addJadwal, calculateJamSelesai, checkJadwalConflict } from '../../../utils/jadwalStorage';
...
const JadwalTambah = ({ onNavigate }) => {
  ...
  const handleSubmit = () => {
    ...
    const conflict = checkJadwalConflict(formData.studio_id, formData.tanggal, formData.jam_mulai, jam_selesai);
    if (conflict) {
      alert('Jadwal bentrok dengan jadwal lain di studio yang sama!');
      return;
    }

    addJadwal({ ...formData, jam_selesai });
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-800 rounded-lg p-6">
        <h2 className="text-2xl font-bold mb-6">Tambah Jadwal Film</h2>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-blue-900 border border-blue-700 rounded-lg p-4">
            <p className="text-sm text-blue-200">
              💡 Sistem akan otomatis mengecek konflik jadwal di studio yang sama.
            </p>
          </div>
